    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhotoPhotoAlbum", x => new { x.AlbumsId, x.PhotosId });
                    table.ForeignKey(
                        name: "FK_PhotoPhotoAlbum_Photo_PhotosId",
                        column: x => x.PhotosId,
                        principalTable: "Photo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PhotoPhotoAlbum_PhotoAlbum_AlbumsId",
                        column: x => x.AlbumsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhotoPhotoAlbum_PhotosId",
                table: "PhotoPhotoAlbum",
                column: "PhotosId");
        }
